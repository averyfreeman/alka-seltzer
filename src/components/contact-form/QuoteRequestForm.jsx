...
import FadeScaleXWrapper from 'components/animated/FadeScaleXWrapper';
import ErrorMsgAlert from 'components/contact-form/valid-response/ErrorMsgAlert';
import ErrOrOkAlert from 'components/contact-form/valid-response/ErrOrOkAlert';
import {
...
const FormMailer = ({ onClose, textColor }) => {
	...
	return (
		<Fragment>
			<AnimatePresence>
				<FadeScaleXWrapper duration={1} key={router.route}>
					<VStack
									...
									>
										<Flex direction="column" justify="center">
											...
											>
												...
												/>
												<FormHelperText align="center">
													e.g. "How much blood meal do you recommend using for
													potted flowers?"
												</FormHelperText>
											</FormControl>
										</Flex>
